...
public class   DWS_login1
{
	public static void main(String[] args) throws InterruptedException
	{
		...
		actions.sendKeys(driver.findElement(By.xpath("//*[@id=\"Email\"]")),"vishalkumarm95@gmail.com").perform();
		actions.sendKeys(driver.findElement(By.xpath("//*[@id=\"Password\"]")),"Bullet@0054").perform();
